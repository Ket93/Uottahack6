...
const getColorForSegment = (batteryLevel, isCharging) => (segment) => {
  if (batteryLevel >= 0.8) {
...
export default class BatteryMeter extends React.Component {
  static defaultProps = {
    batteryLevel: null,
    isCharging: false,
  };
  ...
  render() {
    const { batteryLevel, isCharging } = this.props;
